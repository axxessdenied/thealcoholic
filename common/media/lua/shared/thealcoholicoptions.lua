...
local bV = {
    ...
    HoursToCraveDrink = { 1, 2, 4, 6 },             --hours to crave drink
...
function TheAlcoholic.OnInitModData()
    ...
    TheAlcoholic.values.HoursToCraveDrink       =       sBVars.UseHoursToCraveDrinkCustom and sBVars.HoursToCraveDrinkCustom or bV.HoursToCraveDrink[sBVars.HoursToCraveDrink]
